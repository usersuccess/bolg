    ...
    <div class="row" >
        ...
        <div class="col-xs-10" >
            <div class="panel panel-default">
                <div class="panel-heading" style="background-color: #369;color:#fff;">已关注用户</div>
                <div class="panel-body">
                    <?php
                    $sql = "select * from mr_friend where user_id={$_SESSION['id']}";
                    $result = $pdo->query($sql);
                    while($row = $result->fetch(PDO::FETCH_ASSOC)):
                        ?>
                        <div class="panel panel-default">
                            <a href="fmanager.php?id=<?php echo $row['friend_id'] ?>" style="text-decoration:none;" >
                                <div class="panel-body">
                                    <?php
                                        $sql1 = "select * from mr_user where id={$row['friend_id']}";
                                        $res1 = $pdo->query($sql1);
